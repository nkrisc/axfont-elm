...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$ChooseFile(
			{message: $elm$core$Maybe$Nothing, url: $elm$core$Maybe$Nothing}),
...
var $author$project$Main$FontResponse = function (a) {
	return {$: 'FontResponse', a: a};
};
...
var $author$project$Main$byteStringToBase64 = function (string) {
		...
		switch (msg.$) {
			...
			case 'RequestUrl':
				...
				return _Utils_Tuple2(
					...
					$elm$http$Http$get(
						{
							expect: $elm$http$Http$expectString($author$project$Main$FontResponse),
							url: url
						}));
			case 'FontResponse':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var value = result.a;
					var stringBase64 = $author$project$Main$byteStringToBase64(value);
					if (stringBase64.$ === 'Just') {
						var string = stringBase64.a;
						return _Utils_Tuple2(
							$author$project$Main$Parsing,
							A2(
								$elm$core$Task$perform,
								$author$project$Main$SendFont,
								$elm$core$Task$succeed(string)));
					} else {
						return _Utils_Tuple2(
							$author$project$Main$ChooseFile(
								{
									message: $elm$core$Maybe$Just('oops'),
									url: $elm$core$Maybe$Nothing
								}),
							$elm$core$Platform$Cmd$none);
					}
					...
					return _Utils_Tuple2(
						$author$project$Main$ChooseFile(
							{
								message: $elm$core$Maybe$Just('http error'),
								url: $elm$core$Maybe$Nothing
							}),
						$elm$core$Platform$Cmd$none);
				}
...
var $author$project$Main$FontUpload = {$: 'FontUpload'};
...
var $author$project$Main$withField = F2(
...
var $author$project$Main$formValues = A2($author$project$Main$withField, 'url', $elm$json$Json$Decode$string);
...
var $author$project$Main$onFormSubmit = function (tagger) {
	return A2(
		...
		A2(
			...
			A2($elm$json$Json$Decode$map, tagger, $author$project$Main$formValues)));
};
var $elm$html$Html$Attributes$type_ = $elm$html$Html$Attributes$stringProperty('type');
var $elm$html$Html$Attributes$value = $elm$html$Html$Attributes$stringProperty('value');
var $author$project$Main$urlForm = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Main$onFormSubmit($author$project$Main$RequestUrl)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Load font from URL'),
							A2(
							$elm$html$Html$input,
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value('Get font'),
							$elm$html$Html$Attributes$type_('submit')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Get font from URL')
						]))
				]))
		]));
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$FontUpload),
